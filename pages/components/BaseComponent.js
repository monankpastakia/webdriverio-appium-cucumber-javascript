...
/**
 * BaseComponent class is used to get the locale and platform of the user and to get the locale strings for the components
 *
 * @class BaseComponent
...
class BaseComponent {
   ...
   */
  constructor() {
    this.logger = new Logger(`BaseComponent.js`);
